    ...
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <button
        ...
        className=" mt-6 rounded-lg p-4 font-semibold bg-green-600 flex gap-3
         hover:bg-green-500 items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-background"
      >
